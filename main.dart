    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.add_comment), label: 'Add',backgroundColor: Colors.blue),
          BottomNavigationBarItem(icon: Icon(Icons.history), label: 'history',backgroundColor: Colors.blue),
          BottomNavigationBarItem(icon: Icon(Icons.more), label: 'more',backgroundColor: Colors.blue),
